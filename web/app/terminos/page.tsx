  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        <h1 className="text-base font-semibold text-slate-500">Términos y Condiciones</h1>
        ...
        <div className="mt-3 space-y-2 text-[11px] leading-snug text-slate-400 [&_a]:text-slate-500 [&_a]:underline">
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">1. Quiénes somos</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">2. Objeto del servicio</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">3. Naturaleza orientativa de la valuación</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">5. Derecho de arrepentimiento y reembolsos</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">6. Marketplace y contenido del usuario</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">7. Datos personales</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">8. Limitación de responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-[11px] font-semibold text-slate-500">9. Ley aplicable y jurisdicción</h2>
            <p>
